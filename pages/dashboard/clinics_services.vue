<template>
  <div>
    <v-toolbar elevation="0">
      <v-toolbar-title>Clinics Services</v-toolbar-title>
      <v-spacer></v-spacer>
...
<script>
import formComponent from '../../components/clinics_services/form.vue'
export default {
  ...
  async deleteItem() {
    const data = await this.$axios.$delete(`vendor/clinics_services/${this.itemData.id}`)
  ...
  async getAllData() {
    const data = await this.$axios.$get('vendor/clinics_services')
