          ...
          <v-col cols="6">
            ...
            <v-col cols="6">
              ...
              <v-col cols="6">
                ...
                <v-text-field
                    v-model="itemData.delivery_fees"
                    dense
                    outlined
                    label="Delivery Fees"
                    :rules="validRule"
                ...
                <v-col cols="6">
                  <v-text-field
                      v-model="itemData.delivery_time"
                      dense
                      outlined
                      label="Delivery Time"
                      suffix="Min"
  ...
  props: ['itemData'],
    ...
    computed: {
      ...
      return (
        ...
        && this.itemData.address_ar && this.itemData.open_from &&
        this.itemData.open_to && this.itemData.delivery_fees && this.itemData.delivery_time &&
    ...
    methods: {
      ...
      submit() {
        const formItems = new FormData();
          ...
          formItems.append("delivery_fees", this.itemData.delivery_fees);
          formItems.append("delivery_time", this.itemData.delivery_time);
        if(this.itemData.id) {
      ...
      async addData(formItems) {
        const data = await this.$axios.$post('vendor/pharmacies', formItems)
        try {
      ...
      async updateData(formItems) {
        const data = await this.$axios.$post(`vendor/pharmacies/${this.itemData.id}`, formItems)
        try {
          if(data.success === true){
